...
if __name__ == "__main__":
    ...
    # создаем экземпляр класса и запускаем парсиг данных с номерами 5.2
    parsing52 = Parsing52(file_name, HEAD_PATTERN_52, flag_stop_pattern=HEAD_PATTERN_53)
    parsing52.pars()

    # создаем экземпляр класса и запускаем парсиг данных с номерами 5.3
    ...
    # запускаем перевод дянных по ключу Name
